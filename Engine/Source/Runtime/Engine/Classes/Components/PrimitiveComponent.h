...
public:
	...
	UPROPERTY(EditAnywhere, AdvancedDisplay, BlueprintReadOnly, Category = Rendering, meta = (editcondition = "bRenderCustomDepth", DisplayName = "Das Stencil Value"))
	int32 DasStencilValue = 0;

	UPROPERTY(EditAnywhere, AdvancedDisplay, BlueprintReadOnly, Category = Rendering, meta = (editcondition = "bRenderCustomDepth", DisplayName = "Das Custom Value"))
	int32 DasCustomValue = 0;

	UPROPERTY(EditAnywhere, AdvancedDisplay, BlueprintReadOnly, Category = Rendering, meta = (editcondition = "bRenderCustomDepth", DisplayName = "Das Custom Attributes"))
	TMap<FString, FString> DasCustomAttributes;
...
public:
	...
	*/
	...
	/// <returns></returns>
	UFUNCTION(BlueprintCallable, Category = "Rendering")
	ENGINE_API void SetDasStencilValue(int32 Value);

	UFUNCTION(BlueprintCallable, Category = "Rendering")
	ENGINE_API void SetDasCustomValue(int32 Value);

	UFUNCTION(BlueprintCallable, Category = "Rendering")
	ENGINE_API void SetDasCustomAttribute(const TMap<FString, FString>& mapAttributes);
