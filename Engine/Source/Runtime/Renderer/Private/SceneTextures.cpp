...
void FSceneTextureExtracts::QueueExtractions(FRDGBuilder& GraphBuilder, const FSceneTextures& SceneTextures)
{
	...
	if (EnumHasAnyFlags(SceneTextures.Config.Extracts, ESceneTextureExtracts::CustomDepth))
	{
		...
		ExtractIfProduced(SceneTextures.CustomDepth.DasDepth, DasDepth);
		ExtractIfProduced(SceneTextures.CustomDepth.DasStencil, DasStencil);
		ExtractIfProduced(SceneTextures.CustomDepth.DasCustom, DasCustom);
		ExtractIfProduced(SceneTextures.CustomDepth.DasCustomDepthOn, DasCustomDepthOn);
	}
	...
	FSceneTextureUniformParameters& SceneTextureParameters)
{
	...
	SceneTextureParameters.DasDepthTexture = SystemTextures.Black;
	SceneTextureParameters.DasStencilTexture = SystemTextures.Black;
	SceneTextureParameters.DasCustomTexture = SystemTextures.Black;
	SceneTextureParameters.DasCustomDepthOnTexture = SystemTextures.Black;
